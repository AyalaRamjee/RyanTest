...
export default function UploadPartCommodityTab({ parts, partCommodityMappings, spendData }: UploadPartCommodityTabProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center"><TrendingUp className="mr-2 h-6 w-6" /> Part Commodity Management</CardTitle>
        ...
        <div className="md:col-span-2 space-y-6">
          <section>
            ...
            <div className="space-y-2 p-4 border rounded-md shadow-sm bg-muted/20">
              <label htmlFor="partCommodityFile" className="text-sm font-medium">Choose file for Part-Commodity mapping</label>
              ...
              <p className="text-xs text-muted-foreground">Supported formats: .csv, .xlsx. Ensure columns for Part ID/Number and Commodity Name.</p>
          ...
          <section className="mt-6 pt-6 border-t">
            ...
            {partCommodityMappings.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-4">No commodity mappings available. Generate data or upload a file.</p>
            ) : (
        ...
        <div className="md:col-span-1">
           <Card>
            <CardHeader>
              ...
              <CardDescription>Total spend aggregated by part commodity.</CardDescription>
            </CardHeader>
            <CardContent>
              {spendData.length === 0 ? (
